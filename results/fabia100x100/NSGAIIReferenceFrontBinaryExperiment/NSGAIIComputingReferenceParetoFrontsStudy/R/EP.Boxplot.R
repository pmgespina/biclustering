...
resultDirectory<-"/home/khaosdev/jMetalJava/binary_experiment/NSGAIIComputingReferenceParetoFrontsStudy/data"
...
par(mfrow=c(3,2))
indicator<-"EP"
qIndicator(indicator, "Multi Objective. Binary Encoding Biclustering")
